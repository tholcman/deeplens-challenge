...
from dataset.thdataset import ThDB

def load_th(setName, data_path, shuffle):
    """
    wrapper function for loading th dataset
    ...
    Imdb
    """
    return ThDB(setName, data_path, False)
...
if __name__ == '__main__':
    ...
    if args.dataset == 'pascal':
        ...
        db = load_th(args.set, args.root_path, args.shuffle)
        print("saving list to disk...")
        db.save_imglist(args.target, root=args.root_path)
    else:
